...
namespace RASS_System.Controllers
{
    public class DriversController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Gender,DateOfBirth,DateOfBirthDateOnly,Contact,LicenseNumber,MedicalInfo,AccidentID,VehicleID")] Driver driver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Gender,DateOfBirth,DateOfBirthDateOnly,Contact,LicenseNumber,MedicalInfo,AccidentID,VehicleID")] Driver driver)
        {
            if (id != driver.ID)
            {
                return NotFound();
